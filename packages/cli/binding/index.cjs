    ...
    try {
      ...
      if (!candidateFailed) {
        if (
          ...
          if (bindingPackageVersion !== '0.2.7') {
            throw new Error(
              `WASI binding package version mismatch, expected 0.2.7 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
            );
          }
        }
